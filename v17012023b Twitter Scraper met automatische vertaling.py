...
def collect():
    ...
    query = 'Hogeschool Leiden -is:retweet -is:quote lang:nl'  # give me tweets with this keyword, minus retweets and minus quoted tweets.
    ...
    # tutorial vinden voor het automatisch vertalen van tweets van de ene naar de andere taal: "translation with textblob tutorial python"
    ...
    for tweet in tweets_data:
        translated = TextBlob(tweet['text']).translate(from_lang="nl", to="en")
        tweet['text'] = str(translated)
...
def sentiment_analysis(df):
    ...
    # subjectivity = hoe emotioneel is de tweet? 0.5 of hoger = subjectief (emotioneel)
    Polarity: textual value displaying the sentiment of the text (based on polarity_score).
    # polarity = gebruikt de tweet negatieve of positieve woorden?
    ...
    df_sentiment['bedrijfsid'] = 'None'
    # je kunt handmatig het ID aanpassen per bedrijf
