...
bearer_token = 'AAAAAAAAAAAAAAAAAAAAANQElQEAAAAAAf22VR29asVx2S8JMRnkd9u11xA%3D66M9JMuuod7TbQI0udMkIcCO8znuIHMbsoXNWTizZZXjaXCwn2'
...
class Twitter():
    ...
    def collect(self, searchQuery):
        ...
        print(searchQuery)
        query = f'{searchQuery} -is:retweet -is:quote lang:en'  # give me tweets with this keyword, minus retweets and minus quoted tweets.
    ...
    def sentiment_analysis(self, df, bedrijfPK):
        """
        ...
        df_sentiment['bedrijfs_id'] = bedrijfPK
...
if __name__ == '__main__':
    ...
    with open("companies.txt", "r") as file:
        ...
        for i in file.readlines():
            ...
            twitter.display_options()
            df = twitter.collect(i)
            if df is None:
                print(f"Could not find any data for company {i}")
                index+=1
                continue

            final_df = twitter.sentiment_analysis(df, index)
